...
<script>
    ...
    function body(){
        ...
        $dend='today';
        $params=array('acc'=>$this->acc,'command'=>'GET_OST_POSLUG_ACC');
        s($params);
        s('ip='.$this->ip_club );
...
<div class="p-1 mb-2 bg-info text-white">Ваші залишки предоплачених послуг:</div>
<table class="table table-hover table-sm table-striped">
    <thead class="align-middle text-center">
    <tr class="table-primary">
        <th scope="col" class="text-center wt-200">Заняття</th>
        <th scope="col" class="text-center wt-200">Кількість</th>
    ...
    <tbody  class="align-middle text-center">';
        ...
        <td scope="row" class="text-center tov_name"> '.round($elem['CNT'],0).'</td>
